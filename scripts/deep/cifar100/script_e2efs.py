...
tracker = EmissionsTracker(log_level="warning", output_file=path + "/info_" + precision + "/emissions_script_e2efs_cifar100_" + precision + ".csv")
tracker.start()
...
e2efs_classes = [e2efs_layers.E2EFSSoft]
